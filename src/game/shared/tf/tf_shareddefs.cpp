...
static const char *g_aConditionNames[] =
{
	...
	"TF_COND_CRITBOOSTED_RAGE_BUFF",            // = 42
	"TF_COND_DEFENSEBUFF_HIGH",                 // = 43 - 75% defense! Still damaged by crits.
	"TF_COND_SNIPERCHARGE_RAGE_BUFF",           // = 44 - Sniper Rage - Charge time speed up
	"TF_COND_DISGUISE_WEARINGOFF",              // = 45 - Applied for half-second post-disguise
	"TF_COND_MARKEDFORDEATH_SILENT",            // = 46 - Sans sound
	"TF_COND_DISGUISED_AS_DISPENSER",           // = 47
	"TF_COND_SAPPED",                           // = 48 - Bots only
	"TF_COND_INVULNERABLE_HIDE_UNLESS_DAMAGED", // = 49
	"TF_COND_INVULNERABLE_USER_BUFF",           // = 50
	"TF_COND_HALLOWEEN_BOMB_HEAD",              // = 51
	"TF_COND_HALLOWEEN_THRILLER",               // = 52
	"TF_COND_RADIUSHEAL_ON_DAMAGE",             // = 53
	"TF_COND_CRITBOOSTED_CARD_EFFECT",          // = 54
	"TF_COND_INVULNERABLE_CARD_EFFECT",         // = 55
	"TF_COND_STEALTHED_USER_BUFF",              // = 56 - Any class can have this
	"TF_COND_MEDIGUN_DEBUFF",                   // = 57
	"TF_COND_STEALTHED_USER_BUFF_FADING",       // = 58
	"TF_COND_PREVENT_DEATH",                    // = 59
	...
	"TF_COND_HALLOWEEN_GHOST_MODE",             // = 65
	...
	"TF_COND_BALLOON_HEAD",                     // = 71 - larger head, lower-gravity-feeling jumps
	"TF_COND_MELEE_ONLY",                       // = 72 - melee only
