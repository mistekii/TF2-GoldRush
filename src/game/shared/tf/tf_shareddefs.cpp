...
static const char *g_aConditionNames[] =
{
	...
	"TF_COND_MEDIGUN_SMALL_BULLET_RESIST",      // = 60
	...
	"TF_COND_MVM_BOT_STUN_RADIOWAVE",           // = 70 - Bots only
	...
	"TF_COND_HALLOWEEN_KART",                   // = 80
	"TF_COND_HALLOWEEN_KART_DASH",              // = 81
	"TF_COND_BALLOON_HEAD",                     // = 82 - larger head, lower-gravity-feeling jumps
	"TF_COND_MELEE_ONLY",                       // = 83 - melee only
	...
	"TF_COND_SWIMMING_NO_EFFECTS",              // = 101 - =102_DNOC_FT
	...
	"TF_COND_PASSTIME_PENALTY_DEBUFF",          // = 113
